    ...
    <div class="row">
      <div class="col-6 col-md-3">
        <div class="card card-body">
          ...
          <div class="text-end money">
            <h4>&#8358;{{$student->should_pay + $student->paid}}</h4>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="d-flex justify-content-between">
                    &#8358;<span class="money"> <strong>{{$per_class['class']->fees_sum}}</strong> </span>
                  </td>
                  <td>
                </tr>
                <tr>
          ...
          <div class="modal-body">
            ...
            <form action="{{ route('addpayment') }}" method="POST">
              ...
              <div class="col-12 py-2">
                ...
                <input id="paydate" type="date" max="{{date('Y-m-d')}}"
                  class="form-control @error('paydate') is-invalid @enderror" name="paydate" required autofocus>
                @error('paydate')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
