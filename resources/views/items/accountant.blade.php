...
<div class="text-end">
  <a href="{{ route('additem') }}" class="btn btn-primary">
    <i class='fa fa-add'></i> &nbsp; <span>New Item</span>
  </a>
</div>
  ...
  <div class="col-4">
    <div class="card card-body">
      ...
      <div class="d-flex gap-2 justify-content-end">
        <a href="{{route('updateitem', $item->id)}}" class="btn btn-secondary">Edit Item</a>
        <a href="{{route('deleteitem', $item->id)}}" class="btn btn-outline-danger">Delete Item</a>
      </div>
    </div>
  </div>
  @empty
